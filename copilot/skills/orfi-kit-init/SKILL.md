...
If `<kit-root>` exists and already contains `COPILOT-SESSION-STATE.md` and `ONBOARDING.md`, then this repo is already initialized: tell the user so and **stop** — do not touch anything.
