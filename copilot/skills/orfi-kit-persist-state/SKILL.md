...
Persist current session state to `<kit-root>\COPILOT-SESSION-STATE.md` so work can be resumed after clearing context. Be explicit, factual, and include blockers or unresolved risks.