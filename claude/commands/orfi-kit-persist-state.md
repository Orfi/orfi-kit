...
Persist your current state in `<helper-files-root>\CLAUDE-SESSION-STATE.md` so that we can clear and resume. Remember, never panic or introduce code hacks that break the code base, older unit tests or integration tests! Never lie about anything and be transparent.