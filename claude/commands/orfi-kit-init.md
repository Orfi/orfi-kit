...
- `CLAUDE-SESSION-STATE.md` — placeholder with guiding comment headers for what the session should record. Use this skeleton:

```
# CLAUDE-SESSION-STATE.md — shared session handoff
