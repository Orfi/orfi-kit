...
key. The guardrails in `~/.codex/AGENTS.md` already hold authors to exactly that: they instruct
them to treat this baseline as the contract for a repo that encodes nothing and to report deviation
as a violation.
